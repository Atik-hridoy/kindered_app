  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        border: _buildBorder(widget.borderColor ?? Colors.white.withOpacity(0.3)),
        enabledBorder: _buildBorder(widget.borderColor ?? Colors.white.withOpacity(0.3)),
        ...
        disabledBorder: _buildBorder((widget.borderColor ?? Colors.white.withOpacity(0.3)).withOpacity(0.5)),
